// Siaod.Kr.Z2.1.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
...
/// Вставка нового значения (с перепрошивкой)
...
int main()
{
    ...
    cout << "Обход прошитого дерева после вставки: " << endl;
    ThreadedLNR(rootNode);

    cout << "\n\nВведите значение для поиска: ";
    cin >> n;
    cout << (FindThreatedNode(rootNode, n) != NULL ? "Такое значение в дереве есть" : "Такого значения в дереве нет") << endl;
